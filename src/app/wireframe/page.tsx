    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <div className="border-b border-dashed border-border">
          <div className="px-6 py-3 bg-muted border-b border-border">
            <code className="text-xs text-muted-foreground">
              ServicesEditorialSection — alternating image+text, 5 etapów, CTA, Material Symbols
            </code>
          </div>
        ...
        <div className="border-b border-dashed border-border">
          <div className="px-6 py-3 bg-muted border-b border-border">
            <code className="text-xs text-muted-foreground">
              ServicesOverlaySection — overlay cards 3+2, zdjęcie tło + gradient, hover scale + line, Material Symbols
            </code>
          </div>
