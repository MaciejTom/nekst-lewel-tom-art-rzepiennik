# Prompty do generowania ikon 3D

Styl: glossy plastic toy-like, navy blue + bright red, rounded edges, isometric angle, transparent background.

## 1. Wrench (Szeroki zakres) ✓ DONE
```
