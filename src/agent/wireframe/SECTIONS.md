...
| 6 | **Services Icon Grid** | Centered header (tagline + title + subtitle) + 4-col icon cards. Icon box + title + description. No images. | `services-icon-grid-wireframe.tsx` | — | `services-icon-grid.md` | `services-icon-grid.html` |
